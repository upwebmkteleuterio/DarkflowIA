...
const Settings: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 animate-in fade-in duration-700">
      <div className="mb-10">
        <h2 className="text-4xl font-black text-white font-display tracking-tight uppercase">Configurações de <span className="text-primary italic">Conta</span></h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-surface-dark border border-border-dark p-6 rounded-[32px] shadow-2xl relative overflow-hidden">
            ...
            <div className="mb-6">
              <Badge variant="primary" className="mb-2">PLANO {profile?.role?.toUpperCase() || 'FREE'}</Badge>
              <h4 className="text-2xl font-black text-white italic">DarkFlow Creator</h4>
            </div>

            <div className="space-y-4 pt-6 border-t border-border-dark/50">
              <div className="flex justify-between items-center">
                <span className="text-xs text-slate-400">Status</span>
                <span className="text-xs font-bold text-accent-green uppercase">Ativo</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs text-slate-400">Próxima Renovação</span>
                <span className="text-xs font-bold text-white">12/04/2025</span>
              </div>
            </div>

            <Button variant="outline" fullWidth className="mt-8" size="sm">Mudar de Plano</Button>
          </div>

          <div className="bg-surface-dark border border-border-dark p-6 rounded-[32px] shadow-xl">
        ...
        <div className="md:col-span-2 space-y-6">
          <form onSubmit={handleUpdateProfile} className="bg-surface-dark border border-border-dark p-8 rounded-[40px] shadow-2xl space-y-8">
          ...
          <div className="bg-red-500/5 border border-red-500/10 p-8 rounded-[40px] space-y-4">
            <h4 className="text-red-500 font-black text-xs uppercase tracking-widest flex items-center gap-2">
               <span className="material-symbols-outlined text-sm">warning</span>
               Zona de Perigo
            </h4>
            <p className="text-slate-500 text-xs">Ao excluir sua conta, todos os seus projetos, roteiros e créditos serão permanentemente removidos. Esta ação não pode ser desfeita.</p>
            <Button variant="danger" size="sm">Excluir minha conta permanentemente</Button>
          </div>
        </div>
      </div>
    </div>
